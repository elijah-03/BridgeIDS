...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/class_distribution.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/dashboard_main.png}}
\caption{The BridgeIDS Interactive Dashboard ("Cockpit"). Analysts can adjust feature values using logarithmic sliders and observe real-time prediction probabilities.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/dashboard_analysis.png}}
\caption{Interactive Feature Analysis. The system provides "What-If" sensitivity analysis, showing how changing a feature (e.g., reducing Flow Duration) would affect the prediction confidence.}
