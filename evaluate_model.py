...
def preprocess_batch(df, scaler, le, feature_list):
    ...
    try:
        ...
        base_features = [
            'Dst Port', 'Protocol', 'Hour', 'Total Fwd Packets', 'Fwd Packets Length Total',
            'Flow Duration', 'Flow IAT Mean', 'Fwd Packet Length Max',
            'FIN Flag Count', 'SYN Flag Count', 'RST Flag Count', 'Init Fwd Win Bytes'
        ]
    ...
    for file_path in csv_files:
        ...
        try:
            ...
            for i, chunk in enumerate(chunk_iterator):
                ...
                print(f"  Processed chunk {i+1} ({len(chunk)} samples) - Total: {total_processed}", end='\r')
